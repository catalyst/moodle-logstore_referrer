...
$string['jsonformat_desc'] = 'Use referrer JSON format instead of PHP serialised data in the \'other\' database field.';
$string['pluginname'] = 'Referrer log';
...
$string['cron'] = 'Cron';
$string['logempty'] = 'Store log when http_referrer is empty';
