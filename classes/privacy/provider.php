...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        $collection->add_database_table('logstore_referrer_log', [
    ...
    protected static function get_database_and_table() {
        global $DB;
        return [$DB, 'logstore_referrer_log'];
    }
    ...
    protected static function get_export_subcontext() {
        return [get_string('privacy:path:logs', 'tool_log'), get_string('pluginname', 'logstore_referrer')];
    }
}
