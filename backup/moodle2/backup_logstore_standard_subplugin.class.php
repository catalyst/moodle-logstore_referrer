...
/**
 * Backup implementation for the (tool_log) logstore_referrer subplugin.
 *
...
class backup_logstore_referrer_subplugin extends backup_tool_log_logstore_subplugin {
    ...
    protected function define_logstore_subplugin_structure() {
        ...
        $subpluginlog = new backup_nested_element('logstore_referrer_log', array('id'), array(
        ...
        $subpluginlog->set_source_table('logstore_referrer_log', array('contextid' => backup::VAR_CONTEXTID));
